...
public class ShortestDistanceFollow {
	
	Pathfinding plugin;
	
	public ShortestDistanceFollow(Pathfinding instance) {
		this.plugin = instance;
	}
	
	public ArrayList<Location> nextShortestDistance(Location from, Location to, double precision, ArrayList<Location> blockedLocations, ArrayList<Material> followMat) {
		...
		if (!blockedLocations.contains(from)) {
			if (!locationBlocked(from, followMat)) {
